...
function getFreeTime(dayStartStr, dayEndStr, meetingStartStr, duration) {
  const dayStart = toMinutes(dayStartStr);
  const dayEnd = toMinutes(dayEndStr);
...
console.log(getFreeTime('08:00', '17:30', '14:00', 90));
